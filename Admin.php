Sure, here's the cleaned-up HTML code with consistent indentation:
   ...
   <div class="sidebar">
            ...
            <div class="col">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="dashboard" role="tabpanel"
                        ...
                        <div class="dashboard">
                            ...
                            <div class="row my-5 align-items-center justify-content-center g-5" id="dashrow">
                                <div class="col-xl-6 col-lg-6" id="dashcol">
                                    <div class="card" id="dashcard">
                                        ...
                                        <div class="card-body text-center py-4" id="dashcardBody">
                                            ...
                                            <a href="#userManagement" class="btn btn-primary" id="dashbtn">User
                                                Management</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6" id="dashcol">
                                    <div class="card" id="dashcard">
                                        <img src="/Images/bible01.jpg" class="card-img-top"
                        ...
                        <div class="user-management">
                            ...
                            <div class="container mt-5" id="usertable">
                                ...
                                <div class="table-scroll">
                                    <table class="table table-responsive table-bordered border-dark table-hover text-center table-scroll"
                    ...
                    <div class="tab-pane fade" id="uploadPrompt" role="tabpanel"
                        aria-labelledby="v-pills-prompt-tab">
...
="form-control" id="promptTitle" rows="1"
                                                name="promptTitle"></textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="promptText" class="form-label">Prompt Text</label>
                                            <textarea class="form-control" id="promptText" rows="3"
